...
// echo "<!-- วันเกิดดิบ " . $data_edit['birthday'] . " -->";

$birthday = cv_year_en2th($data_edit['birthday']);
// echo "<!-- วันเกิดดิบ " . $data_edit['birthday'] . " -->";
// echo "วันเกิดแปลงแล้ว " . $birthday;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                ...
                                <input class="form-control datethai" type="text" id="birthday" name="birthday" value="<?php echo $birthday; ?>" required>
