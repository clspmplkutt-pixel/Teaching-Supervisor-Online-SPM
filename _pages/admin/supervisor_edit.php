...
if ($operation == $module . "_save") {
    ...
    if ($has_people_id == "0") {
        ...
        if ($has_people_id_u) {
            ...
            // exit;
            location_to("?module=usersupervisor", "2");
        } else {
    ...
    if ($result->rowCount() != 0) {
        ...
        location_to("?module=usersupervisor", "0");
    } else {
        ...
        <form method="POST">
            ...
            <div class="card card-success">
                ...
                <div class="card-footer text-center">
                    ...
                    <a href="?module=usersupervisor" class="btn btn-danger"><i class="fa-solid fa-ban"></i> ยกเลิก</a>
