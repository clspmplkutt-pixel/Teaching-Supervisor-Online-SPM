...
<?php
$title_page = "จัดการชื่อตำแหน่งบุคลากร";
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                if ($row['position_status'] == "1") {
                                    $active_icon = "<a href=\"#\" onclick='set_PersonPositionType(".$row["id"].",0)'><i class=\"fa-solid fa-circle-check text-success fa-xl\"></i></a>";
                                } else if ($row['position_status'] == "0") {
                                    $active_icon = "<a href=\"#\" onclick='set_PersonPositionType(".$row["id"].",1)'><i class=\"fa-solid fa-circle-xmark text-danger fa-xl\"></i></a>";
                                }
                            ?>
                                <tr>
