...
$data = $database->get($tbl, "*", ["model_id" => $model_id]);
            ...
            <div class="card-body">
                <form action="?module=<?php echo $module; ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="model_id" placeholder="รหัสรูปแบบ" name="model_id" value="<?php echo $data['model_id']; ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="model_name">รูปแบบการจัดการเรียนรู้: </label>
                        <input type="text" class="form-control" id="model_name" placeholder="รูปแบบการจัดการเรียนรู้" name="model_name" value="<?php echo $data['model_name']; ?>" required>
                    </div>
