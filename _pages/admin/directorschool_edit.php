...
$title_page = "แก้ไขข้อมูลผู้อำนวยการ/รองผู้อำนวยการ";
$tbl = "tbl_Users";
...
if ($operation == $module . "_save") {
    ...
    if ($has_people_id == "0") {
        ...
        // echo $id;
        $has_people_id_u = $database->debug()->has($tbl, ["people_id" => $people_id]);
        // echo $has_people_id_u;
        // exit;
        if ($has_people_id_u) {
            echo "มีสมาชิกท่านนี้อยู่แล้วครับ มีอยู่แล้วครับ ";
            // exit;
            location_to("?module=userdirectorschool", "2");
        } else {
    ...
    if ($result->rowCount() != 0) {
        ...
        location_to("?module=userdirectorschool", "0");
    } else {
            ...
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                <label for="chairman">หัวหน้ากลุ่มสาระ</label>
                                <select name="chairman" id="chairman" class="custom-select select2bs4" required>
                                    <option value=""></option>
                                    <option value="0" <?php echo (($data_edit['chairman'] == "0" || $data_edit['headDepartment'] == "" || $data_edit['headDepartment'] == null) ? " selected" : ""); ?>>ไม่ได้เป็นประธานสหวิทยาเขต</option>
                ...
                <div class="card-footer text-center">
                    ...
                    <a href="?module=userdirectorschool" class="btn btn-danger"><i class="fa-solid fa-ban"></i> ยกเลิก</a>
