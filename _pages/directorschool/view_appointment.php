...
if ($operation == $module . "_save") {
    ...
    $plan_ds_comment = test_input($plan_ds_comment);
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php
                                if ($data_plan['plan_approve'] == "1") {
                                    echo "<h1 class='text-success'>อนุมัติใช้แผน</h1>";
                                } else {
                                    echo "<h1 class='text-danger'>ไม่อนุมัติใช้แผน</h1>";
                                }
                                ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <?php echo htmlspecialchars_decode($data_plan['plan_ds_comment']); ?>
                            <!-- <textarea name="plan_ds_comment" id="plan_ds_comment" class="summernote" height="5" width="100%" disabled></textarea> -->
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="mb-3 mt-3">
                                <div class="form-group">
                                    ...
                                    if ($data_plan['committee1'] != "") {
                                        $data_committee1 = $database->get("tbl_Users", "*", ["people_id" => $data_plan['committee1']]);
                                        echo "<h3 class='text-success'>" . $arrayPrefix[$data_committee1['prefix']] . $data_committee1['name'] . " " . $data_committee1['lastname'] . "(" . $database->get("tbl_school", "school_name", ["school_id" => $data_committee1['school']]) . ")</h3>";
                                    }else{
                                        echo "-";
                                    }
                                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($data_plan['committee2'] != "") {
                                        $data_committee2 = $database->get("tbl_Users", "*", ["people_id" => $data_plan['committee2']]);
                                        echo "<h3 class='text-success'>" . $arrayPrefix[$data_committee2['prefix']] . $data_committee2['name'] . " " . $data_committee2['lastname'] . "(" . $database->get("tbl_school", "school_name", ["school_id" => $data_committee2['school']]) . ")</h3>";
                                    }else{
                                        echo "-";
                                    }
                                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($data_plan['committee3'] != "") {
                                        $data_committee3 = $database->get("tbl_Users", "*", ["people_id" => $data_plan['committee3']]);
                                        echo "<h3 class='text-success'>" . $arrayPrefix[$data_committee3['prefix']] . $data_committee3['name'] . " " . $data_committee3['lastname'] . "(" . $database->get("tbl_school", "school_name", ["school_id" => $data_committee3['school']]) . ")</h3>";
                                    }else{
                                        echo "-";
                                    }
                                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($data_plan['committee4'] != "") {
                                        $data_committee4 = $database->get("tbl_Users", "*", ["people_id" => $data_plan['committee4']]);
                                        echo "<h3 class='text-success'>" . $arrayPrefix[$data_committee4['prefix']] . $data_committee4['name'] . " " . $data_committee4['lastname'] . "(" . $database->get("tbl_school", "school_name", ["school_id" => $data_committee4['school']]) . ")</h3>";
                                    }else{
                                        echo "-";
                                    }
                                    ?>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3 mt-3">
                                <div class="form-group">
                                    ...
                                    <?php
                                    if ($data_plan['committee5'] != "") {
                                        $data_committee5 = $database->get("tbl_Users", "*", ["people_id" => $data_plan['committee5']]);
                                        echo "<h3 class='text-success'>" . $arrayPrefix[$data_committee5['prefix']] . $data_committee5['name'] . " " . $data_committee5['lastname'] . "(" . $database->get("tbl_school", "school_name", ["school_id" => $data_committee5['school']]) . ")</h3>";
                                    }else{
                                        echo "-";
                                    }
                                    ?>
    ...
    $(document).ready(function() {
        ...
        $("#plan_approve").change(function() {
            ...
            if (plan_approve == "0") {
                ...
                $('#plan_ds_comment').removeAttr("disabled");
