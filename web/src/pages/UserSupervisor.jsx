  ...
  const handleRemove = (peopleId) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        navigate(`/user_remove?people_id=${peopleId}&from=usersupervisor`);
      }
    });
  };
      ...
      <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div className="card card-success">
          <div className="card-header">
            <h3 className="card-title"><i className="fa-solid fa-school-circle-check"></i> ผู้เข้าใช้งานระบบ ศึกษานิเทศ</h3>
          </div>
                ...
                <tbody>
                  ...
                  {rows.map((row, idx) => (
                    <tr key={row.id}>
                      ...
                      <td>{lookups.khet[row.khet_code] || ''}</td>
                      <td>
                        <div className="btn-group">
                          ...
                          <Link to={`/resetPwd?id=${row.id}&from_module=usersupervisor`} className="btn btn-info btn-sm">
