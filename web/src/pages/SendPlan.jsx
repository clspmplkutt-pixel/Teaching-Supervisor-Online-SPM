  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        assessment: `1. วิธี: ${form.Measurement_how}\n2. เครื่องมือ: ${form.Measurement_tools}\n3. เกณฑ์: ${form.Measurement_scoring}\n4. ผล: ${form.Measurement_outcomes}\n\n[วัตถุประสงค์]\nK: ${form.objectives_knowledge}\nP: ${form.objectives_process}\nA: ${form.objectives_attribute}`,
        plan_file: driveUrl,
